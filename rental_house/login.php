...
if (isset($_POST["login"])) {
    ...
    if ($row1) {
        ...
        if ($role == "Administrator") {
            ...
            // Fetching tenant data for non-administrator and non-manager roles
            $fname = $row['fname'];
            $lname = $row['lname'];
            $stat = $row['status'];
            $id = $row['tenant_id'];
            ...
            if ($stat == 0) {
                ...
                // Your existing code for handling contract expiration...
            } elseif ($stat == 3) {
                $_SESSION['username'] = $uname;
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4"><b><b>ONLINE HOUSE RENTAL MANAGEMENT SYSTEM</b></b><br/><br/>Login</h1>
