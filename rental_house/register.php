      ...
      elseif ((strlen($lname)<3) || (strlen($lname)>10)) {
        ...
        if((ctype_digit($occ)) && !($occ == "")){
          ...
          elseif ((strlen($pno1) < 10)|| (strlen($pno2) < 10)) {
            ...
            elseif ((strlen($cpno1) > 10)|| (strlen($cpno2) > 10)) {
            ...
            elseif ((strlen($cpno1) < 10)|| (strlen($cpno2) < 10)) {
              ...
              elseif (((strlen($cpno3) > 10)|| (strlen($cpno4) > 10)) && (!($cpno4 == "") || !($cpno3 == ""))) {
            ...
            <div class="p-5">
              ...
              <form class="user" action="<?php echo $_SERVER['PHP_SELF']; ?>" method = "POST">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="pno1" value="<?php echo @$pno1; ?>" placeholder="Phone Number 1 e.g; 0717******" required>
                  </div>
                </div>
                <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                  <input type="text" class="form-control form-control-user" name="pno2" value="<?php echo @$pno2; ?>" placeholder="Phone Number 2 e.g; 0717******" required>
                </div>
                <div class="col-sm-6">
                ...
                <div class="form-group">
                  <iframe src="contract1.pdf" width="1000px" height="400px" style="border: none;"></iframe>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="cpno1" value="<?php echo @$cpno1; ?>" placeholder="Phone Number 1 e.g; 0717******" required>
                  </div>
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="cpno2" value="<?php echo @$cpno2; ?>" placeholder="Phone Number 1 e.g; 0717******" required>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="cpno3" value="<?php echo @$cpno3; ?>" placeholder="Phone Number 2 e.g; 0717******">
                  </div>
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="cpno4" value="<?php echo @$cpno4; ?>" placeholder="Phone Number 2 e.g; 0717******">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
