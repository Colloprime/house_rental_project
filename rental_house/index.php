            ...
            <div class="product-slider owl-carousel owl-theme">
              <div class="item">
                <div class="product">
                  <div class="flip-container">
                    <div class="flipper">
                      <div class="front"><a><img src="rental.png" alt="" class="img-fluid"></a></div>
              ...
              <div class="item">
                <div class="product">
                  ...
                  <div class="text">
                    <h3><a href="login.php">Ksh. 100,000/=</a></h3>
                    <p class="price">
                      Available Rooms:<br/><?php
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-2 mb-lg-0">
            <p class="text-center text-lg-left">Copyright &copy; OHRMS 2023</p>
          </div>
        </div>
      </div>
    </div>
