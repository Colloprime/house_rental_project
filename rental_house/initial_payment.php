...
if (isset($_POST['submit'])) {
  ...
  if (mysqli_num_rows($query) == 1) {
    if ($pin != $pin_no) {
      ...
      if($amount > $amm ){
        echo "<script> alert('Insufficient Amount: your balance is: Ksh. ".$amm."');</script>";
      }
      else {
                 ...
                 <table class="table table-borderless" id="dataTable" width="100%" cellspacing="0">
                   ...
                   <tbody>
                     ...
                     <tr>
                       ...
                       <td><input type='text' class='form-control form-control-user' name='pno1' value="0737364643" readonly></td>
                     </tr>
                     <tr>
                       <td>
                        Your PIN Number:
